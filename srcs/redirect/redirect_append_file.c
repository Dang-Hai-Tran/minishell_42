...
/*   Updated: 2023/06/20 12:05:45 by datran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param file_path A string representing the path to the file to which the output should be appended.
 * @return An integer flag that indicates whether the operation was successful or not. The flag is defined as SUCCESS_FLAG, which is equal to 0.
*/
