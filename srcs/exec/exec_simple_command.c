...
/*   Updated: 2023/07/17 10:33:52 by datran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * it will use the `exec_general` function. The function also handles exit 
 * code management.
 *
 * @param simple_command Pointer to a `t_simple_command` structure containing
 * 	the command to be executed.
 *
 * @return SUCCESS_FLAG if the command is executed successfully, ERROR_FLAG
 * 	otherwise.
 */
