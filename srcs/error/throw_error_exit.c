...
/*   Updated: 2023/06/23 12:02:27 by datran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Print an error message to the standard error output stream (stderr) and then 
 ...
 * @param exit_code An integer representing the exit code to be returned by the 
 * program.
